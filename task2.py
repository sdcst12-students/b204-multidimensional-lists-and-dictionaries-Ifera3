...
for i in teams:
     teamData[i] = {'gamesPlayed' : 0, 'wins' : 0, 'losses' : 0, 'ties' : 0, 'goalsFor' : 0, 'goalsAgainst' : 0}

for i in games:
    if i['homeScore'] == i['awayScore']:
        teamData[i['home']]['ties'] = teamData[i['home']]['ties'] + 1
        teamData[i['away']]['ties'] = teamData[i['away']]['ties'] + 1
    elif i['homeScore'] > i['awayScore']:
        teamData[i['home']]['wins'] = teamData[i['home']]['wins'] + 1
        teamData[i['away']]['losses'] = teamData[i['away']]['losses'] + 1
    elif i['homeScore'] < i['awayScore']:
        teamData[i['home']]['losses'] = teamData[i['home']]['losses'] + 1
        teamData[i['away']]['wins'] = teamData[i['away']]['wins'] + 1
    teamData[i['home']]['gamesPlayed'] = teamData[i['home']]['gamesPlayed'] + 1
    teamData[i['home']]['goalsFor'] = teamData[i['home']]['goalsFor'] + i['homeScore']
    teamData[i['home']]['goalsAgainst'] = teamData[i['home']]['goalsAgainst'] + i['awayScore']
    teamData[i['away']]['gamesPlayed'] = teamData[i['away']]['gamesPlayed'] + 1
    teamData[i['away']]['goalsFor'] = teamData[i['away']]['goalsFor'] + i['awayScore']
    teamData[i['away']]['goalsAgainst'] = teamData[i['away']]['goalsAgainst'] + i['homeScore']
